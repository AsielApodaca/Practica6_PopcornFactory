...
class Catalogo : AppCompatActivity() {
    ...
    fun cargarSeries(){
        ...
        series.add(Pelicula("El monstruo viejo de Seul", R.drawable.elmonstruo, R.drawable.elmonstruovieja, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana.",arrayListOf<Cliente>()))
...
class PeliculaAdapter: BaseAdapter {
    ...
    override fun getView(pe: Int, p1: View?, p2: ViewGroup?): View {
        ...
        image.setOnClickListener() {
            ...
            intent.putExtra("numberSeats",(20))
